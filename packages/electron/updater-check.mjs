const MISSING_UPDATE_FEED_RE =
  /404|ENOTFOUND|Cannot find (?:channel|latest)|latest-linux(?:-arm64)?\.yml|HttpError:\s*404|status code 404|ENOENT[^\n]*app-update\.yml/i;
...
export const shouldSkipDesktopUpdateCheck = ({ platform, updateConfigPath, existsSync }) =>
  platform === 'win32'
  && typeof updateConfigPath === 'string'
  && updateConfigPath.length > 0
