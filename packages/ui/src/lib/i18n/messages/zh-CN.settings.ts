export const settingsDict = {
  ...
  'settings.view.home.cards.plugins.title': '插件',
  'settings.view.home.cards.plugins.description': '管理 Grok 插件',
  ...
  'settings.view.nav.group.general': 'Grok Code',
  'settings.view.nav.group.projects': '工作区',
  'settings.view.nav.group.opencode': 'Grok',
  ...
  'settings.page.plugins.title': '插件',
  ...
  'settings.openchamber.tunnel.field.newPresetTokenPlaceholder': '令牌',
  ...
  'settings.openchamber.tunnel.badge.quick': '快速',
  'settings.openchamber.tunnel.badge.remote': '远程',
  'settings.openchamber.tunnel.badge.local': '本地',
  ...
  'settings.remoteInstances.direct.headers.title': '附加请求头',
  'settings.remoteInstances.direct.headers.description': '桌面 API 请求可使用可选 HTTP 请求头；Authorization 保留给连接令牌。',
  'settings.remoteInstances.direct.headers.field.namePlaceholder': '请求头名称',
  'settings.remoteInstances.direct.headers.field.valuePlaceholder': '请求头值',
  'settings.remoteInstances.direct.headers.actions.add': '添加请求头',
  'settings.remoteInstances.direct.headers.removeAria': '移除请求头',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Grok Code 连接二维码',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.state.viaRelay': '中继',
  ...
  'settings.remoteInstances.relay.title': 'Grok Code 中继',
  ...
  'settings.gitIdentities.editor.field.authToken': '访问令牌',
  ...
  'settings.gitIdentities.editor.field.host': '主机',
  ...
  'settings.openchamber.passkeys.title': '通行密钥',
  ...
  'settings.openchamber.opencodeCli.title': 'Grok CLI',
  ...
  'settings.providers.page.auth.apiKeyLabel': 'API 密钥',
  ...
  'settings.voice.page.field.apiKey': 'API 密钥',
  ...
  'settings.openchamber.visual.field.expandedEditorToolbarAria': '始终显示编辑器工具栏',
  'settings.openchamber.visual.field.expandedEditorToolbar': '始终显示编辑器工具栏（停靠在文件标签下方）',
  ...
  'settings.openchamber.visual.field.followUpBehaviorDescription': '智能体仍在回答时，选择按下 Enter 发送后续消息后的处理方式。',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': '立即引导',
  'settings.openchamber.visual.option.followUpBehavior.queue.label': '加入队列',
  'settings.plugins.dialog.add.tab.marketplace': 'Grok 应用市场',
  'settings.plugins.marketplace.trustWarning': '插件可以执行代码并访问项目数据。安装前请检查来源和发布者；点击“安装”即表示你明确信任该插件。',
  'settings.plugins.marketplace.search': '搜索 Grok 应用市场',
  'settings.plugins.marketplace.loading': '正在加载应用市场…',
  'settings.plugins.marketplace.empty': '没有匹配的市场插件。',
  'settings.plugins.marketplace.install': '安装',
  'settings.plugins.marketplace.installing': '正在安装…',
  'settings.plugins.marketplace.installed': 'Grok 插件已安装',
  'settings.plugins.marketplace.installFailed': 'Grok 插件安装失败',
  'settings.plugins.grok.updateFailed': 'Grok 插件更新失败',
  'settings.plugins.grok.uninstallFailed': 'Grok 插件卸载失败',
  'settings.page.grokAccounts.title': 'Grok 账号',
  'settings.grokAccounts.description': '登录、隔离管理多个 Grok 账号，并选择新 Grok 会话使用哪个账号。',
  'settings.grokAccounts.section.title': '账号档案',
  'settings.grokAccounts.section.description': '每个新增档案都有独立的 Grok 私有目录，账号凭据不会在档案之间复制。',
  'settings.grokAccounts.actions.add': '添加账号',
  'settings.grokAccounts.actions.switch': '切换',
  'settings.grokAccounts.actions.relogin': '重新登录',
  'settings.grokAccounts.actions.login': '登录',
  'settings.grokAccounts.actions.deviceLogin': '设备码登录',
  'settings.grokAccounts.actions.logout': '退出登录',
  'settings.grokAccounts.actions.remove': '删除档案',
  'settings.grokAccounts.actions.copy': '复制',
  'settings.grokAccounts.actions.create': '创建档案',
  'settings.grokAccounts.switchNotice': '切换账号会关闭当前 Grok 运行时。已有聊天记录仍会保留，但下一条消息会使用所选账号启动新的 Grok 运行时；正在生成的回复必须先结束。',
  'settings.grokAccounts.toast.created': '账号档案已创建',
  'settings.grokAccounts.toast.switched': '已切换到 {name}',
  'settings.grokAccounts.toast.loggedOut': '已退出登录',
  'settings.grokAccounts.toast.removed': '账号档案已删除',
  'settings.grokAccounts.toast.copied': '登录信息已复制',
  'settings.grokAccounts.toast.copyFailed': '无法复制登录信息',
  'settings.grokAccounts.badge.current': '当前账号',
  'settings.grokAccounts.badge.loggedIn': '已登录',
  'settings.grokAccounts.badge.loggedOut': '未登录',
  'settings.grokAccounts.kind.system': '使用系统默认 Grok 档案',
  'settings.grokAccounts.kind.isolated': '独立隔离的 Grok 档案',
  'settings.grokAccounts.authUpdated': '登录更新于 {time}',
  'settings.grokAccounts.login.running': '正在登录',
  'settings.grokAccounts.login.succeeded': '登录完成',
  'settings.grokAccounts.login.failed': '登录失败',
  'settings.grokAccounts.create.title': '添加 Grok 账号',
  'settings.grokAccounts.create.description': '先创建独立档案，再通过浏览器 OAuth 或设备码完成登录。',
  'settings.grokAccounts.create.placeholder': '例如：工作账号',
  'settings.grokAccounts.remove.title': '删除账号档案？',
  'settings.grokAccounts.remove.description': '这会从本机删除“{name}”及其隔离的 Grok 登录凭据，操作无法撤销。',
} as const;
