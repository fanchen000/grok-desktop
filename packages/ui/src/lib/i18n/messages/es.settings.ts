...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.plugins.dialog.add.tab.marketplace": "Marketplace de Grok",
  "settings.plugins.marketplace.trustWarning": "Los plugins pueden ejecutar código y acceder a los datos del proyecto. Revisa la fuente y el editor antes de instalar. Al pulsar Instalar confías explícitamente en este plugin.",
  "settings.plugins.marketplace.search": "Buscar en el Marketplace de Grok",
  "settings.plugins.marketplace.loading": "Cargando marketplace…",
  "settings.plugins.marketplace.empty": "No hay plugins coincidentes.",
  "settings.plugins.marketplace.install": "Instalar",
  "settings.plugins.marketplace.installing": "Instalando…",
  "settings.plugins.marketplace.installed": "Plugin de Grok instalado",
  "settings.plugins.marketplace.installFailed": "No se pudo instalar el plugin de Grok",
  "settings.plugins.grok.updateFailed": "No se pudo actualizar el plugin de Grok",
  "settings.plugins.grok.uninstallFailed": "No se pudo desinstalar el plugin de Grok",
