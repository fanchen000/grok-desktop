export const settingsDict = {
  ...
  'settings.plugins.marketplace.trustWarning': 'Plugins can run code and access project data. Review the source and publisher before installing. Clicking Install explicitly trusts this plugin.',
  'settings.plugins.marketplace.search': 'Search Grok Marketplace',
  'settings.plugins.marketplace.loading': 'Loading marketplace…',
  'settings.plugins.marketplace.empty': 'No matching marketplace plugins.',
  'settings.plugins.marketplace.install': 'Install',
  'settings.plugins.marketplace.installing': 'Installing…',
  'settings.plugins.marketplace.installed': 'Grok plugin installed',
  'settings.plugins.marketplace.installFailed': 'Failed to install Grok plugin',
  'settings.plugins.grok.updateFailed': 'Failed to update Grok plugin',
  'settings.plugins.grok.uninstallFailed': 'Failed to uninstall Grok plugin',
  ...
  'settings.grokAccounts.section.description': 'Each added profile has its own private Grok home directory. Credentials are never copied between profiles.',
  ...
  'settings.grokAccounts.switchNotice': 'Switching accounts closes the current Grok runtime. Existing chat history stays visible, but the next message starts a fresh Grok runtime with the selected account. A running reply must finish first.',
  ...
  'settings.grokAccounts.create.description': 'Create an isolated profile first, then sign in through the browser or device-code flow.',
  ...
  'settings.grokAccounts.remove.description': 'This removes “{name}” and its isolated Grok credentials from this computer. This cannot be undone.',
} as const;
