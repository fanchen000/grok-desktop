...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.plugins.dialog.add.tab.marketplace": "Marketplace do Grok",
  "settings.plugins.marketplace.trustWarning": "Plugins podem executar código e acessar dados do projeto. Revise a origem e o publicador antes de instalar. Clicar em Instalar confia explicitamente neste plugin.",
  "settings.plugins.marketplace.search": "Pesquisar no Marketplace do Grok",
  "settings.plugins.marketplace.loading": "Carregando marketplace…",
  "settings.plugins.marketplace.empty": "Nenhum plugin correspondente.",
  "settings.plugins.marketplace.install": "Instalar",
  "settings.plugins.marketplace.installing": "Instalando…",
  "settings.plugins.marketplace.installed": "Plugin do Grok instalado",
  "settings.plugins.marketplace.installFailed": "Falha ao instalar o plugin do Grok",
  "settings.plugins.grok.updateFailed": "Falha ao atualizar o plugin do Grok",
  "settings.plugins.grok.uninstallFailed": "Falha ao desinstalar o plugin do Grok",
