...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.plugins.dialog.add.tab.marketplace': 'Grok 마켓플레이스',
  'settings.plugins.marketplace.trustWarning': '플러그인은 코드를 실행하고 프로젝트 데이터에 접근할 수 있습니다. 설치 전에 출처와 게시자를 검토하세요. 설치를 누르면 이 플러그인을 명시적으로 신뢰합니다.',
  'settings.plugins.marketplace.search': 'Grok 마켓플레이스 검색',
  'settings.plugins.marketplace.loading': '마켓플레이스 불러오는 중…',
  'settings.plugins.marketplace.empty': '일치하는 마켓플레이스 플러그인이 없습니다.',
  'settings.plugins.marketplace.install': '설치',
  'settings.plugins.marketplace.installing': '설치 중…',
  'settings.plugins.marketplace.installed': 'Grok 플러그인이 설치되었습니다',
  'settings.plugins.marketplace.installFailed': 'Grok 플러그인 설치에 실패했습니다',
  'settings.plugins.grok.updateFailed': 'Grok 플러그인 업데이트에 실패했습니다',
  'settings.plugins.grok.uninstallFailed': 'Grok 플러그인 제거에 실패했습니다',
