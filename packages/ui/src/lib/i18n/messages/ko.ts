...
import { grokHistoryMessagesEn, grokUsageMessagesKo } from './grok-history';
...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.appshot': 'Appshot 저장',
  'contextPanel.browser.recordStart': '기록 시작',
  'contextPanel.browser.recordStop': '기록 중지',
  'contextPanel.browser.replayLatest': '최근 기록 재생',
  'contextPanel.browser.appshotSaved': 'Appshot이 저장되었습니다',
  'contextPanel.browser.recordingStarted': '브라우저 기록이 시작되었습니다',
  'contextPanel.browser.recordingStopped': '브라우저 기록이 저장되었습니다',
  'contextPanel.browser.replayCompleted': '브라우저 재생이 완료되었습니다',
  'contextPanel.browser.actionFailed': '브라우저 작업에 실패했습니다',
};
