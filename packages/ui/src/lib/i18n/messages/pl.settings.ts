...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.plugins.dialog.add.tab.marketplace': 'Marketplace Grok',
  'settings.plugins.marketplace.trustWarning': 'Wtyczki mogą uruchamiać kod i uzyskiwać dostęp do danych projektu. Przed instalacją sprawdź źródło i wydawcę. Kliknięcie Instaluj oznacza jawne zaufanie tej wtyczce.',
  'settings.plugins.marketplace.search': 'Szukaj w Marketplace Grok',
  'settings.plugins.marketplace.loading': 'Ładowanie marketplace…',
  'settings.plugins.marketplace.empty': 'Brak pasujących wtyczek.',
  'settings.plugins.marketplace.install': 'Instaluj',
  'settings.plugins.marketplace.installing': 'Instalowanie…',
  'settings.plugins.marketplace.installed': 'Wtyczka Grok zainstalowana',
  'settings.plugins.marketplace.installFailed': 'Nie udało się zainstalować wtyczki Grok',
  'settings.plugins.grok.updateFailed': 'Nie udało się zaktualizować wtyczki Grok',
  'settings.plugins.grok.uninstallFailed': 'Nie udało się odinstalować wtyczki Grok',
