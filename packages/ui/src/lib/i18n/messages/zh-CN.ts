...
import { grokHistoryMessagesZhCn } from './grok-history';

export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  ...grokHistoryMessagesZhCn,
  ...
  'gitView.history.actions.cherryPick': '拣选提交',
  ...
  'gitView.history.actions.reset': '重置...',
  ...
  'gitView.history.actions.revert': '还原提交',
  ...
  'contextPanel.mode.stagedDiff': '暂存区差异',
  'contextPanel.mode.workingDiff': '工作区差异',
  ...
  'diffView.actions.review': '审查',
  'diffView.actions.reviewAria': '审查更改',
  'diffView.reviewDialog.title': '审查更改',
  'diffView.reviewDialog.description': '为当前更改单独启动一个审查会话。',
  'diffView.reviewDialog.generateHandoff': '生成交接说明',
  'diffView.reviewDialog.autoReview': '运行自动审查循环',
  'diffView.reviewDialog.info': '最好在实施这些更改的原会话中启动此流程。',
  'diffView.reviewDialog.actions.cancel': '取消',
  'diffView.reviewDialog.actions.start': '开始审查',
  'diffView.reviewDialog.actions.starting': '正在启动...',
  'diffView.reviewDialog.toast.noSessionDirectory': '会话目录不可用',
  'diffView.reviewDialog.toast.startFailed': '无法启动审查流程',
  ...
  'session.newWorktree.issueNumber': '议题 #{number}',
  ...
  'session.githubIntegration.tabs.issues': '议题',
  'session.githubIntegration.tabs.pullRequests': '拉取请求',
  ...
  'session.githubIntegration.selected.issueNumber': '议题 #{number}',
  ...
  'chat.emptyState.draftTitle': '今天要做什么？',
  'chat.emptyState.draftTitleWithProject': '要在 {project} 里做什么？',
  'chat.draftPresets.explore.label': '探索代码库',
  'chat.draftPresets.catchup.label': '帮我了解进展',
  'chat.draftPresets.weigh.label': '比较可选方案',
  'chat.draftPresets.plan.label': '开始功能规划',
  'chat.draftPresets.craftGoal.label': '创建 Goal',
  'chat.draftPresets.scheduleTask.label': '安排计划任务',
  'chat.draftPresets.debug.label': '调试问题',
  'chat.draftPresets.review.label': '审查我的更改',
  'chat.draftStarters.add': '添加快捷入口',
  'chat.draftStarters.searchPlaceholder': '搜索命令和技能…',
  'chat.draftStarters.empty': '没有可添加的内容',
  'chat.draftStarters.sectionBuiltIn': '内置',
  'chat.draftStarters.sectionCommands': '命令',
  'chat.draftStarters.sectionSkills': '技能',
  'chat.draftStarters.remove': '移除',
  ...
  'chat.queuedMessage.title': '排队中的消息',
  ...
  'chat.modelControls.webFetch': '网页抓取',
  ...
  'desktopHostSwitcher.instance.local': '本机',
  ...
  'common.date.yesterdayWithTime': '昨天 {time}',
  'common.relative.justNow': '刚刚',
  'common.relative.minutesAgoShort': '{count} 分钟前',
  'common.relative.hoursAgoShort': '{count} 小时前',
  'common.relative.daysAgoShort': '{count} 天前',
  'common.relative.weeksAgoShort': '{count} 周前',
  'common.relative.yearsAgoShort': '{count} 年前',
  'common.relative.daysAgoCompact': '{count} 天前',
  'common.relative.weeksAgoCompact': '{count} 周前',
  ...
  'contextFileOpen.failure.tooLarge': '文件过大，无法打开（超过 {count} 行）',
  'contextFileOpen.failure.missing': '找不到文件',
  'contextFileOpen.failure.unreadable': '无法打开文件',
  'quota.window.5h': '5 小时',
  'quota.window.7d': '7 天限额',
  'quota.window.7dSonnet': 'Sonnet 7 天限额',
  'quota.window.7dOpus': 'Opus 7 天限额',
  'quota.window.weekly': '每周限额',
  'quota.window.daily': '每日',
  'quota.window.monthly': '每月限额',
  'quota.window.credits': '额度',
  'quota.window.creditsBalance': '剩余额度',
  'quota.window.billingCycle': '计费周期',
  'quota.window.auto': '自动',
  'quota.window.api': 'API',
  'quota.window.planLimit': '套餐限额',
  'quota.window.onDemand': '按需',
  'quota.window.session': '会话',
  'quota.window.premium': '高级交互',
  'quota.window.chat': '聊天请求',
  'quota.window.completions': '补全次数',
  'quota.window.premiumInteractions': '高级交互',
  'contextPanel.browser.appshot': '保存状态快照',
  'contextPanel.browser.recordStart': '开始录制',
  'contextPanel.browser.recordStop': '停止录制',
  'contextPanel.browser.replayLatest': '回放最近录制',
  'contextPanel.browser.appshotSaved': '状态快照已保存',
  'contextPanel.browser.recordingStarted': '浏览器录制已开始',
  'contextPanel.browser.recordingStopped': '浏览器录制已保存',
  'contextPanel.browser.replayCompleted': '浏览器回放已完成',
  'contextPanel.browser.actionFailed': '浏览器操作失败',
};
