...
import { grokHistoryMessagesZhTw } from './grok-history';

export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  ...grokHistoryMessagesZhTw,
  ...
  'contextPanel.browser.appshot': '儲存狀態快照',
  'contextPanel.browser.recordStart': '開始錄製',
  'contextPanel.browser.recordStop': '停止錄製',
  'contextPanel.browser.replayLatest': '重播最近錄製',
  'contextPanel.browser.appshotSaved': '狀態快照已儲存',
  'contextPanel.browser.recordingStarted': '瀏覽器錄製已開始',
  'contextPanel.browser.recordingStopped': '瀏覽器錄製已儲存',
  'contextPanel.browser.replayCompleted': '瀏覽器重播已完成',
  'contextPanel.browser.actionFailed': '瀏覽器操作失敗',
};
